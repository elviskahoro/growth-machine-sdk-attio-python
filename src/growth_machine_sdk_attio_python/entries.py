...
class Entries(BaseSDK):
    ...
    def post_v2_lists_list_entries_query(
        ...
        *,
        ...
        :param list:
        :param filter_: An object used to filter results to a subset of results. See the [full guide to filtering and sorting here](/docs/filtering-and-sorting).
        :param sorts: An object used to sort results. See the [full guide to filtering and sorting here](/docs/filtering-and-sorting).
        :param limit: The maximum number of results to return. Defaults to 500. See the [full guide to pagination here](/docs/pagination).
        :param offset: The number of results to skip over before returning. Defaults to 0. See the [full guide to pagination here](/docs/pagination).
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(
                http_res.text, models.PostV2ListsListEntriesQueryResponse
            )
        if utils.match_response(http_res, "404", "application/json"):
            response_data = utils.unmarshal_json(
                http_res.text, errors.PostV2ListsListEntriesQueryNotFoundErrorData
            )
            raise errors.PostV2ListsListEntriesQueryNotFoundError(data=response_data)
    ...
    def post_v2_lists_list_entries(
        ...
        *,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(
                http_res.text, models.PostV2ListsListEntriesResponse
            )
        if utils.match_response(http_res, "400", "application/json"):
            response_data = utils.unmarshal_json(
                http_res.text, errors.PostV2ListsListEntriesValueNotFoundErrorData
            )
            raise errors.PostV2ListsListEntriesValueNotFoundError(data=response_data)
        if utils.match_response(http_res, "404", "application/json"):
            response_data = utils.unmarshal_json(
                http_res.text, errors.PostV2ListsListEntriesNotFoundErrorData
            )
            raise errors.PostV2ListsListEntriesNotFoundError(data=response_data)
        if utils.match_response(http_res, "4XX", "*"):
            http_res_text = utils.stream_to_text(http_res)
            raise errors.APIError(
                "API error occurred", http_res.status_code, http_res_text, http_res
    ...
    def put_v2_lists_list_entries(
        ...
        *,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(
                http_res.text, models.PutV2ListsListEntriesResponse
            )
        if utils.match_response(http_res, "400", "application/json"):
            response_data = utils.unmarshal_json(
                http_res.text, errors.MultipleMatchResultsErrorData
            )
            raise errors.MultipleMatchResultsError(data=response_data)
        if utils.match_response(http_res, "404", "application/json"):
            response_data = utils.unmarshal_json(
                http_res.text, errors.PutV2ListsListEntriesNotFoundErrorData
            )
            raise errors.PutV2ListsListEntriesNotFoundError(data=response_data)
        if utils.match_response(http_res, "4XX", "*"):
            http_res_text = utils.stream_to_text(http_res)
            raise errors.APIError(
                "API error occurred", http_res.status_code, http_res_text, http_res
    ...
    def get_v2_lists_list_entries_entry_id_(
        ...
        *,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(
                http_res.text, models.GetV2ListsListEntriesEntryIDResponse
            )
        if utils.match_response(http_res, "404", "application/json"):
            response_data = utils.unmarshal_json(
                http_res.text, errors.GetV2ListsListEntriesEntryIDNotFoundErrorData
            )
            raise errors.GetV2ListsListEntriesEntryIDNotFoundError(data=response_data)
        if utils.match_response(http_res, "4XX", "*"):
            http_res_text = utils.stream_to_text(http_res)
            raise errors.APIError(
                "API error occurred", http_res.status_code, http_res_text, http_res
    ...
    def patch_v2_lists_list_entries_entry_id_(
        ...
        *,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(
                http_res.text, models.PatchV2ListsListEntriesEntryIDResponse
            )
        if utils.match_response(http_res, "400", "application/json"):
            response_data = utils.unmarshal_json(
                http_res.text,
                errors.PatchV2ListsListEntriesEntryIDImmutableValueErrorData,
            )
        ...
        if utils.match_response(http_res, "404", "application/json"):
            response_data = utils.unmarshal_json(
                http_res.text, errors.PatchV2ListsListEntriesEntryIDNotFoundErrorData
            )
            raise errors.PatchV2ListsListEntriesEntryIDNotFoundError(data=response_data)
        if utils.match_response(http_res, "4XX", "*"):
            http_res_text = utils.stream_to_text(http_res)
            raise errors.APIError(
                "API error occurred", http_res.status_code, http_res_text, http_res
    ...
    def put_v2_lists_list_entries_entry_id_(
        ...
        *,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(
                http_res.text, models.PutV2ListsListEntriesEntryIDResponse
            )
        if utils.match_response(http_res, "400", "application/json"):
            response_data = utils.unmarshal_json(
                http_res.text,
                errors.PutV2ListsListEntriesEntryIDImmutableValueErrorData,
            )
        ...
        if utils.match_response(http_res, "404", "application/json"):
            response_data = utils.unmarshal_json(
                http_res.text, errors.PutV2ListsListEntriesEntryIDNotFoundErrorData
            )
            raise errors.PutV2ListsListEntriesEntryIDNotFoundError(data=response_data)
        if utils.match_response(http_res, "4XX", "*"):
            http_res_text = utils.stream_to_text(http_res)
            raise errors.APIError(
                "API error occurred", http_res.status_code, http_res_text, http_res
    ...
    def delete_v2_lists_list_entries_entry_id_(
        ...
        *,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(
                http_res.text, models.DeleteV2ListsListEntriesEntryIDResponse
            )
        if utils.match_response(http_res, "404", "application/json"):
            response_data = utils.unmarshal_json(
                http_res.text, errors.DeleteV2ListsListEntriesEntryIDNotFoundErrorData
            )
    ...
    def get_v2_lists_list_entries_entry_id_attributes_attribute_values(
        ...
        *,
        ...
        if utils.match_response(http_res, "400", "application/json"):
            response_data = utils.unmarshal_json(
                http_res.text,
                errors.GetV2ListsListEntriesEntryIDAttributesAttributeValuesValidationTypeErrorData,
            )
            raise errors.GetV2ListsListEntriesEntryIDAttributesAttributeValuesValidationTypeError(
                data=response_data
            )
        if utils.match_response(http_res, "404", "application/json"):
            response_data = utils.unmarshal_json(
