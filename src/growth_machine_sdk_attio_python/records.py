...
class Records(BaseSDK):
        ...
        *,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(
                http_res.text, models.PostV2ObjectsObjectRecordsQueryResponse
            )
        if utils.match_response(http_res, "400", "application/json"):
            response_data = utils.unmarshal_json(http_res.text, errors.FilterErrorData)
            raise errors.FilterError(data=response_data)
        if utils.match_response(http_res, "404", "application/json"):
            response_data = utils.unmarshal_json(
                http_res.text, errors.PostV2ObjectsObjectRecordsQueryNotFoundErrorData
            )
    ...
    def post_v2_objects_object_records(
        ...
        *,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(
                http_res.text, models.PostV2ObjectsObjectRecordsResponse
            )
        if utils.match_response(http_res, "400", "application/json"):
            response_data = utils.unmarshal_json(
                http_res.text, errors.PostV2ObjectsObjectRecordsValueNotFoundErrorData
            )
        ...
        if utils.match_response(http_res, "404", "application/json"):
            response_data = utils.unmarshal_json(
                http_res.text, errors.PostV2ObjectsObjectRecordsNotFoundErrorData
            )
            raise errors.PostV2ObjectsObjectRecordsNotFoundError(data=response_data)
        if utils.match_response(http_res, "4XX", "*"):
            http_res_text = utils.stream_to_text(http_res)
            raise errors.APIError(
                "API error occurred", http_res.status_code, http_res_text, http_res
    ...
    def put_v2_objects_object_records(
        ...
        *,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(
                http_res.text, models.PutV2ObjectsObjectRecordsResponse
            )
        if utils.match_response(http_res, "400", "application/json"):
            response_data = utils.unmarshal_json(
                http_res.text, errors.PutV2ObjectsObjectRecordsValueNotFoundErrorData
            )
            raise errors.PutV2ObjectsObjectRecordsValueNotFoundError(data=response_data)
        if utils.match_response(http_res, "404", "application/json"):
            response_data = utils.unmarshal_json(
                http_res.text, errors.PutV2ObjectsObjectRecordsNotFoundErrorData
            )
            raise errors.PutV2ObjectsObjectRecordsNotFoundError(data=response_data)
        if utils.match_response(http_res, "4XX", "*"):
            http_res_text = utils.stream_to_text(http_res)
            raise errors.APIError(
                "API error occurred", http_res.status_code, http_res_text, http_res
    ...
    def get_v2_objects_object_records_record_id_(
        ...
        *,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(
                http_res.text, models.GetV2ObjectsObjectRecordsRecordIDResponse
            )
        if utils.match_response(http_res, "404", "application/json"):
            response_data = utils.unmarshal_json(
                http_res.text, errors.GetV2ObjectsObjectRecordsRecordIDNotFoundErrorData
            )
    ...
    def patch_v2_objects_object_records_record_id_(
        ...
        *,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(
                http_res.text, models.PatchV2ObjectsObjectRecordsRecordIDResponse
            )
        if utils.match_response(http_res, "400", "application/json"):
            response_data = utils.unmarshal_json(
                http_res.text,
        ...
        if utils.match_response(http_res, "404", "application/json"):
            response_data = utils.unmarshal_json(
                http_res.text,
                errors.PatchV2ObjectsObjectRecordsRecordIDNotFoundErrorData,
            )
    ...
    def put_v2_objects_object_records_record_id_(
        ...
        *,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(
                http_res.text, models.PutV2ObjectsObjectRecordsRecordIDResponse
            )
        if utils.match_response(http_res, "400", "application/json"):
            response_data = utils.unmarshal_json(
                http_res.text,
                errors.PutV2ObjectsObjectRecordsRecordIDMissingValueErrorData,
            )
        ...
        if utils.match_response(http_res, "404", "application/json"):
            response_data = utils.unmarshal_json(
                http_res.text, errors.PutV2ObjectsObjectRecordsRecordIDNotFoundErrorData
            )
    ...
    def delete_v2_objects_object_records_record_id_(
        ...
        *,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(
                http_res.text, models.DeleteV2ObjectsObjectRecordsRecordIDResponse
            )
        if utils.match_response(http_res, "404", "application/json"):
            response_data = utils.unmarshal_json(
                http_res.text,
                errors.DeleteV2ObjectsObjectRecordsRecordIDNotFoundErrorData,
            )
    ...
    def get_v2_objects_object_records_record_id_entries(
        ...
        *,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(
                http_res.text, models.GetV2ObjectsObjectRecordsRecordIDEntriesResponse
            )
        if utils.match_response(http_res, "4XX", "*"):
            http_res_text = utils.stream_to_text(http_res)
            raise errors.APIError(
