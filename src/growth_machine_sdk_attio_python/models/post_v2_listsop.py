...
class PostV2ListsWorkspaceAccess(str, Enum):
...
class PostV2ListsLevel(str, Enum):
...
class PostV2ListsNotFoundType(str, Enum):
    INVALID_REQUEST_ERROR = "invalid_request_error"


class PostV2ListsNotFoundCode(str, Enum):
    NOT_FOUND = "not_found"
...
class PostV2ListsBadRequestType(str, Enum):
    INVALID_REQUEST_ERROR = "invalid_request_error"


class PostV2ListsCodeValueNotFound(str, Enum):
