...
class PostV2CommentsFormat3(str, Enum):
...
class TypeWorkspaceMember3(str, Enum):
...
class PostV2CommentsFormat2(str, Enum):
    r"""The format that the comment content is provided in. The `plaintext` format uses the line feed character `\n` to create new lines within the note content. Rich text formatting and links are not supported."""

    PLAINTEXT = "plaintext"


class TypeWorkspaceMember2(str, Enum):
    WORKSPACE_MEMBER = "workspace-member"
...
class PostV2CommentsFormat1(str, Enum):
    r"""The format that the comment content is provided in. The `plaintext` format uses the line feed character `\n` to create new lines within the note content. Rich text formatting and links are not supported."""

    PLAINTEXT = "plaintext"


class TypeWorkspaceMember1(str, Enum):
    WORKSPACE_MEMBER = "workspace-member"
...
class PostV2CommentsBadRequestType(str, Enum):
    INVALID_REQUEST_ERROR = "invalid_request_error"


class PostV2CommentsCode(str, Enum):
