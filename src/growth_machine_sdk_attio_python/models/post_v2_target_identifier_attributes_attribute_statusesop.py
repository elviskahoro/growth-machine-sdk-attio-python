...
class PostV2TargetIdentifierAttributesAttributeStatusesTarget(str, Enum):
...
class PostV2TargetIdentifierAttributesAttributeStatusesConflictType(str, Enum):
    INVALID_REQUEST_ERROR = "invalid_request_error"


class PostV2TargetIdentifierAttributesAttributeStatusesConflictCode(str, Enum):
    SLUG_CONFLICT = "slug_conflict"


class PostV2TargetIdentifierAttributesAttributeStatusesNotFoundType(str, Enum):
    INVALID_REQUEST_ERROR = "invalid_request_error"


class PostV2TargetIdentifierAttributesAttributeStatusesNotFoundCode(str, Enum):
    NOT_FOUND = "not_found"


class PostV2TargetIdentifierAttributesAttributeStatusesBadRequestType(str, Enum):
    INVALID_REQUEST_ERROR = "invalid_request_error"


class PostV2TargetIdentifierAttributesAttributeStatusesCodeValidationType(str, Enum):
