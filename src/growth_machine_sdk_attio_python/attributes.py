...
class Attributes(BaseSDK):
        ...
        *,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(
                http_res.text, models.GetV2TargetIdentifierAttributesResponse
            )
    ...
    def post_v2_target_identifier_attributes(
        ...
        *,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(
                http_res.text, models.PostV2TargetIdentifierAttributesResponse
            )
        if utils.match_response(http_res, "400", "application/json"):
            response_data = utils.unmarshal_json(
                http_res.text,
                errors.PostV2TargetIdentifierAttributesValidationTypeErrorData,
            )
        ...
        if utils.match_response(http_res, "404", "application/json"):
            response_data = utils.unmarshal_json(
                http_res.text, errors.PostV2TargetIdentifierAttributesNotFoundErrorData
            )
        ...
        if utils.match_response(http_res, "409", "application/json"):
            response_data = utils.unmarshal_json(
                http_res.text,
                errors.PostV2TargetIdentifierAttributesSlugConflictErrorData,
            )
    ...
    def get_v2_target_identifier_attributes_attribute_(
        ...
        *,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(
                http_res.text, models.GetV2TargetIdentifierAttributesAttributeResponse
            )
        if utils.match_response(http_res, "404", "application/json"):
            response_data = utils.unmarshal_json(
                http_res.text,
    ...
    def patch_v2_target_identifier_attributes_attribute_(
        ...
        *,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(
                http_res.text, models.PatchV2TargetIdentifierAttributesAttributeResponse
            )
        if utils.match_response(http_res, "400", "application/json"):
            response_data = utils.unmarshal_json(
                http_res.text, errors.SystemEditUnauthorizedErrorData
            )
            raise errors.SystemEditUnauthorizedError(data=response_data)
        if utils.match_response(http_res, "404", "application/json"):
            response_data = utils.unmarshal_json(
                http_res.text,
