...
class WorkspaceMembers(BaseSDK):
        ...
        *,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(
                http_res.text, models.GetV2WorkspaceMembersResponse
            )
    ...
    def get_v2_workspace_members_workspace_member_id_(
        ...
        *,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(
                http_res.text, models.GetV2WorkspaceMembersWorkspaceMemberIDResponse
            )
        if utils.match_response(http_res, "404", "application/json"):
            response_data = utils.unmarshal_json(
                http_res.text,
                errors.GetV2WorkspaceMembersWorkspaceMemberIDNotFoundErrorData,
            )
